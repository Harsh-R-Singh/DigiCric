...
const ResetPassword = () => {
  ...
  return (
    <div className="flex-grow flex items-center justify-center px-4 relative z-10 w-full min-h-[calc(100vh-140px)]">
      ...
      <div className="w-full max-w-[440px] z-10 reset-container">
        <div className="bg-[#2b1c17]/40 backdrop-blur-xl border border-[#5a4138]/20 rounded-xl p-8 md:p-12 shadow-[0_0_50px_rgba(236,91,19,0.1)] relative overflow-hidden group">
          ...
          <div className="flex flex-col items-center mb-10">
            <h1 className="font-headline text-3xl font-bold tracking-tighter text-[#f8ddd4] uppercase mb-2 text-center">New Password</h1>
            <p className="text-[#e2bfb3] font-medium text-xs tracking-widest uppercase text-center">Enter your new password below</p>
          </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="space-y-2">
              <label className="block text-[12px] font-bold uppercase tracking-[0.05em] text-[#ec5b13]">New Password</label>
            ...
            <div className="space-y-2">
              <label className="block text-[12px] font-bold uppercase tracking-[0.05em] text-[#ec5b13]">Confirm Password</label>
              <div className="relative">
                <input 
