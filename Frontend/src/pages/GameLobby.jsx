              ...
              <div className="md:col-span-1 lg:col-span-7 flex flex-col gap-8">
                ...
                <div className="flex flex-col gap-4 animate-in">
                  ...
                  {!selectedMode ? (
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <Link to={`/${selectedMode === 'camera' ? 'camera' : 'game'}`} state={{ gameFormat: 'single_wicket' }} className="group relative overflow-hidden bg-primary text-white rounded-xl p-8 transition-all hover:shadow-[0_0_25px_rgba(236,91,19,0.5)] flex flex-col justify-between min-h-[200px] text-left block">
                        <div className="relative z-10">
